...
public interface GbStreamMapper {
    ...
    List<GbStream> selectByGBId(@Param("gbId") String gbId);
    ...
    @Select("<script> " +
        ...
        "</script>")
    List<DeviceChannel> queryGbStreamListInPlatform(@Param("platformId") String platformId, @Param("usPushingAsStatus") boolean usPushingAsStatus);
    ...
    @Update("UPDATE wvp_gb_stream " +
        ...
        "WHERE app=#{app} AND stream=#{stream}")
    void updateMediaServer(@Param("app") String app, @Param("stream") String stream, @Param("mediaServerId") String mediaServerId);
