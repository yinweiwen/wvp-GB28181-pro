...
public interface StreamProxyMapper {
    ...
    List<StreamProxyItem> selectForEnable(@Param("enable") boolean enable);
    ...
    List<StreamProxyItem> selectInMediaServer(@Param("id") String id);
    ...
    void deleteAutoRemoveItemByMediaServerId(@Param("mediaServerId") String mediaServerId);
    ...
    List<StreamProxyItem> selectAutoRemoveItemByMediaServerId(@Param("mediaServerId") String mediaServerId);
